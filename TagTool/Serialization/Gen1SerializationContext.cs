...
namespace TagTool.Serialization
{
    public class Gen1SerializationContext : ISerializationContext
    {
        ...
        {
            return (uint)(address - GameCache.TagCacheGen1.BaseTagAddress + GameCache.BaseMapFile.Header.TagDataOffset);
        }
        ...
        public EndianReader BeginDeserialize(TagStructureInfo info)
        {
            ...
            reader.SeekTo(Tag.Offset - GameCache.TagCacheGen1.BaseTagAddress + GameCache.BaseMapFile.Header.TagDataOffset);
            return reader;
        }
