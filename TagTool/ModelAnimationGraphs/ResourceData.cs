    ...
    class ResourceDataCommand : Command
    {
        ...
        private static bool ImportResource(ModelAnimationGraph Definition, GameCacheContext CacheContext, IReadOnlyList<string> args)
        {
            ...
            using (var stream = File.Open(filePath, FileMode.Open, FileAccess.ReadWrite))
            {
                ...
                {
                    case "textures":
                        CacheContext.AddResource(Definition.ResourceGroups[index].Resource, BlamCore.Common.ResourceLocation.Textures, stream);
                        break;
                    case "textures_b":
                        CacheContext.AddResource(Definition.ResourceGroups[index].Resource, BlamCore.Common.ResourceLocation.TexturesB, stream);
                        break;
                    case "resources":
                        CacheContext.AddResource(Definition.ResourceGroups[index].Resource, BlamCore.Common.ResourceLocation.Resources, stream);
                        break;
                    case "resources_b":
                        CacheContext.AddResource(Definition.ResourceGroups[index].Resource, BlamCore.Common.ResourceLocation.ResourcesB, stream);
                        break;
                    case "audio":
                        CacheContext.AddResource(Definition.ResourceGroups[index].Resource, BlamCore.Common.ResourceLocation.Audio, stream);
                        break;
                    case "lightmaps":
                        CacheContext.AddResource(Definition.ResourceGroups[index].Resource, BlamCore.Common.ResourceLocation.Lightmaps, stream);
                        break;
                    case "render_models":
                        CacheContext.AddResource(Definition.ResourceGroups[index].Resource, BlamCore.Common.ResourceLocation.RenderModels, stream);
                        break;
                    default:
