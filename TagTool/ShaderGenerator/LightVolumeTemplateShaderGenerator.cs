...
namespace TagTool.ShaderGenerator
{
    public class LightVolumeTemplateShaderGenerator : TemplateShaderGenerator
    {
        ...
        public LightVolumeTemplateShaderGenerator(HaloOnlineCacheContext cacheContext, TemplateShaderGenerator.Drawmode drawmode, Int32[] args, Int32 arg_pos = 0) : base(
                drawmode,
