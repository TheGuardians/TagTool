...
namespace TagTool.ShaderGenerator
{
    public partial class ShaderGenerator
    {
        ...
        static MultiValueDictionary<object, object> template_uniforms = new MultiValueDictionary<object, object>
        {
            ...
            {Albedo.Detail_Blend,  new TemplateParameter(typeof(Albedo), "albedo_detail_blend_s1", ShaderParameter.RType.Sampler) }, // Manually added (Unknown bitmap)
            ...
            {Albedo.Three_Detail_Blend,  new TemplateParameter(typeof(Albedo), "detail_map3", ShaderParameter.RType.Sampler) },
