...
namespace TagTool.Commands.ScenarioStructureBSPs
{
    class CollisionTestCommand : Command
    {
        ...
        public override object Execute(List<string> args)
        {
            ...
            var resourceContext = new ResourceSerializationContext(CacheContext, BSP.CollisionBspResource.HaloOnlinePageableResource);
            ...
            CacheContext.ExtractResource(BSP.CollisionBspResource.HaloOnlinePageableResource, resourceDataStream);
