...
namespace TagTool.Commands.Porting
{
    class PortMultiplayerScenarioCommand : Command
    {
        ...
        MapFile CreateMapFile(Stream cacheStream, CachedTag scenarioTag, string mapName, string mapDescription, string scenarioName)
        {
        ...
        void GenerateMapFile(Stream cacheStream, CachedTag scenarioTag, string mapName, string mapDescription)
        {
            ...
            MapFile map = CreateMapFile(cacheStream, scenarioTag, mapName, mapDescription, scenarioName);
