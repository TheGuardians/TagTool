        ...
        private TagResourceReference ConvertStructureBspTagResources(ScenarioStructureBsp bsp, Dictionary<ResourceLocation, Stream> resourceStreams)
        {
            ...
            using (var resourceWriter = new EndianWriter(dataStream, EndianFormat.LittleEndian))
            {
                ...
                foreach (var collisionBsp in resourceDefinition.CollisionBsps)
                {
                    ...
                    collisionBsp.Bsp3dNodes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    collisionBsp.Planes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    collisionBsp.Leaves.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    collisionBsp.Bsp2dReferences.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    collisionBsp.Bsp2dNodes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    collisionBsp.Surfaces.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    collisionBsp.Edges.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    collisionBsp.Vertices.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                ...
                foreach (var largeCollisionBsp in resourceDefinition.LargeCollisionBsps)
                {
                    ...
                    largeCollisionBsp.Bsp3dNodes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    largeCollisionBsp.Planes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    for (var i = 0; i < largeCollisionBsp.Planes.Count; i++)
                        CacheContext.Serializer.Serialize(dataContext, BlamCache.Deserializer.Deserialize<CollisionGeometry.Plane>(dataContext));

                    StreamUtil.Align(dataStream, 0x10);
                    blamResourceStream.Position = largeCollisionBsp.Leaves.Address.Offset;
                    largeCollisionBsp.Leaves.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    largeCollisionBsp.Bsp2dReferences.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    largeCollisionBsp.Bsp2dNodes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    largeCollisionBsp.Surfaces.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    largeCollisionBsp.Edges.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    largeCollisionBsp.Vertices.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                ...
                foreach (var instance in resourceDefinition.InstancedGeometry)
                {
                    ...
                    instance.CollisionInfo.Bsp3dNodes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    instance.CollisionInfo.Planes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    instance.CollisionInfo.Leaves.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    instance.CollisionInfo.Bsp2dReferences.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    instance.CollisionInfo.Bsp2dNodes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    instance.CollisionInfo.Surfaces.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    instance.CollisionInfo.Edges.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    instance.CollisionInfo.Vertices.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    foreach (var collisionGeometry in instance.CollisionGeometries)
                    {
                        ...
                        collisionGeometry.Bsp3dNodes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                        for (var i = 0; i < collisionGeometry.Bsp3dNodes.Count; i++)
                            CacheContext.Serializer.Serialize(dataContext, BlamCache.Deserializer.Deserialize<CollisionGeometry.Bsp3dNode>(dataContext));

                        StreamUtil.Align(dataStream, 0x10);
                        blamResourceStream.Position = collisionGeometry.Planes.Address.Offset;
                        collisionGeometry.Planes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                        for (var i = 0; i < collisionGeometry.Planes.Count; i++)
                            CacheContext.Serializer.Serialize(dataContext, BlamCache.Deserializer.Deserialize<CollisionGeometry.Plane>(dataContext));

                        StreamUtil.Align(dataStream, 0x10);
                        blamResourceStream.Position = collisionGeometry.Leaves.Address.Offset;
                        collisionGeometry.Leaves.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                        ...
                        collisionGeometry.Bsp2dReferences.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                        ...
                        collisionGeometry.Bsp2dNodes.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                        for (var i = 0; i < collisionGeometry.Bsp2dNodes.Count; i++)
                            CacheContext.Serializer.Serialize(dataContext, BlamCache.Deserializer.Deserialize<CollisionGeometry.Bsp2dNode>(dataContext));

                        StreamUtil.Align(dataStream, 0x10);
                        blamResourceStream.Position = collisionGeometry.Surfaces.Address.Offset;
                        collisionGeometry.Surfaces.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                        ...
                        collisionGeometry.Edges.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                        for (var i = 0; i < collisionGeometry.Edges.Count; i++)
                            CacheContext.Serializer.Serialize(dataContext, BlamCache.Deserializer.Deserialize<CollisionGeometry.Edge>(dataContext));

                        StreamUtil.Align(dataStream, 0x10);
                        blamResourceStream.Position = collisionGeometry.Vertices.Address.Offset;
                        collisionGeometry.Vertices.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    foreach (var moppCode in instance.BspPhysics)
                    {
                        ...
                        moppCode.Data.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    instance.Unknown1.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
                    ...
                    */
                    ...
                    instance.Unknown3.Address = new CacheAddress(CacheAddressType.Data, (int)dataStream.Position);
