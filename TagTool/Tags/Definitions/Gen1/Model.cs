...
{
    [TagStructure(Name = "model", Tag = "mode", Size = 0xE8)]
    public class Model : TagStructure
    {
        ...
        public List<ModelRegionBlock> Regions;
        ...
        public class ModelRegionBlock : TagStructure
        {
            ...
            [TagField(Length = 0x20)]
            public byte[] Padding;
            public List<ModelRegionPermutationBlock> Permutations;
            
            [TagStructure(Size = 0x58)]
            public class ModelRegionPermutationBlock : TagStructure
            {
                [TagField(Length = 32)]
                public string Name;
                public FlagsValue Flags;
        ...
        public class ModelGeometryBlock : TagStructure
        {
            public FlagsValue Flags;
            [TagField(Length = 0x20)]
            public byte[] Padding;
            ...
            public class ModelGeometryPartBlock : TagStructure
            {
                public FlagsValue Flags;
