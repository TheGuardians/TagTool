...
namespace TagTool.Tags.Definitions.Gen1
{
    ...
    public class Biped : TagStructure
    {
        ...
        {
            public FlagsValue Flags; // this is the period for the above function (lower values make the function oscillate quickly, higher values make it oscillate slowly
            public float Period; // seconds
            public ScalePeriodByValue ScalePeriodBy; // multiply this function by the above period
            public FunctionValue Function;
            public ScaleFunctionByValue ScaleFunctionBy; // multiply this function by the result of the above function
            public WobbleFunctionValue WobbleFunction; // the curve used for the wobble
            ...
            public AddValue Add; // add this function to the final result of all of the above math
            public ScaleResultByValue ScaleResultBy; // multiply this function (from a weapon, vehicle, etc.) final result of all of the above math
            public BoundsModeValue BoundsMode; // controls how the bounds, below, are used
            ...
            public float ScaleBy; // applied before clip, ignored if zero
