...
{
    [TagStructure(Name = "scenario_creature_resource", Tag = "*rea", Size = 0x34)]
    public class ScenarioCreatureResource : TagStructure
    {
        ...
        public List<ScenarioCreaturePaletteBlock> Palette;
        public List<ScenarioCreatureBlock> Objects;
