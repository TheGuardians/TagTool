...
{
    [TagStructure(Name = "scenario_bipeds_resource", Tag = "*ipd", Size = 0x34)]
    public class ScenarioBipedsResource : TagStructure
    {
        ...
        public List<ScenarioBipedPaletteBlock> Palette;
        public List<ScenarioBipedBlock> Objects;
