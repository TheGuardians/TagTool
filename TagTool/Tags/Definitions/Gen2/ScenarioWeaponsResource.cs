...
{
    [TagStructure(Name = "scenario_weapons_resource", Tag = "*eap", Size = 0x34)]
    public class ScenarioWeaponsResource : TagStructure
    {
        ...
        public List<ScenarioWeaponPaletteBlock> Palette;
        public List<ScenarioWeaponBlock> Objects;
