...
{
    [TagStructure(Name = "render_model_lightmap_atlas", Tag = "rmla", Size = 0xB8)]
    public class RenderModelLightmapAtlas : TagStructure
    {
        public GlobalRenderGeometryStruct AtlasGeometry;
