...
{
    [TagStructure(Name = "shader_mux", Tag = "rmmx", Size = 0x1C)]
    public class ShaderMux : RenderMethod
    {
        // defines global material type for channel 0 of the mux shader
        public StringId MaterialName0;
        // defines global material type for channel 1 of the mux shader
        public StringId MaterialName1;
        // defines global material type for channel 2 of the mux shader
        public StringId MaterialName2;
        // defines global material type for channel 3 of the mux shader
