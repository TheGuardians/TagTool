...
{
    [TagStructure(Name = "imposter_model", Tag = "impo", Size = 0xD8)]
    public class ImposterModel : TagStructure
    {
        ...
        public List<ImposterModeNodeBlock> NodeMaps;
        public List<RenderModelRegionBlock> Regions;
        public GlobalRenderGeometryStruct Geometry;
        
        [TagStructure(Size = 0x8)]
        public class ImposterModeNodeBlock : TagStructure
        {
            public StringId Name;
            public short BaseNodeIndex;
            [TagField(Length = 0x2, Flags = TagFieldFlags.Padding)]
            public byte[] Padding;
        }
