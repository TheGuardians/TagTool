...
{
    [TagStructure(Name = "decal_system", Tag = "decs", Size = 0x2C)]
    public class DecalSystem : TagStructure
    {
        ...
        public int RingBufferSizeSinglePlayer;
        // material shader lifetime is modulated from 1 to 0 over this time
        public float MaterialShaderFadeTime;
        // NOTE - If set to non-zero, this will override manual scaling in Sapien and smash it with these values
        public RealPoint2d DecalScaleOverride;
        // if zero, will use random sprite
        public Bounds<short> RandomSpriteIndexBounds;
        public List<DecalDefinitionBlock> Decals;
        ...
        public class DecalDefinitionBlock : TagStructure
        {
            ...
            public float ClampAngle; // degrees
            // Projections at greater than this angle will not be drawn
            public float CullAngle; // degrees
            public float DepthBias;
            public float StripUCoordinateTileLength;
            public float StripMaxProfileDistance;
            public float RuntimeBitmapAspect;
            
            [Flags]
            public enum DecalFlags : uint
            {
                RenderInTransparentsPass = 1 << 0
            }
