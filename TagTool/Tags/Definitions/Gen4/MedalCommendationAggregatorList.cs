...
{
    [TagStructure(Name = "medal_commendation_aggregator_list", Tag = "meco", Size = 0xC)]
    public class MedalCommendationAggregatorList : TagStructure
    {
        public List<MedalcommendationAggregator> Lists;
        
        [TagStructure(Size = 0x18)]
        public class MedalcommendationAggregator : TagStructure
        {
            public StringId CommendationToAward;
