...
{
    [TagStructure(Name = "scenario_structure_lighting_info", Tag = "stli", Size = 0x58)]
    public class ScenarioStructureLightingInfo : TagStructure
    {
        public int ImportInfoChecksum;
        public List<StructureLightingGenericLightDefinitionBlock> GenericLightDefinitions;
        public List<StructureLightingGenericLightInstanceBlock> GenericLightInstances;
        public List<ScreenSpaceLightShaderOverrideBlock> ScreenSpaceLightShaderOverride;
        public List<StructurelightingCinematicLightInstanceBlockStruct> CinematicLightInstances;
        public LightScalarFunctionStruct SunIntensityMultiplier;
        
        [TagStructure(Size = 0x1C8)]
        public class StructureLightingGenericLightDefinitionBlock : TagStructure
        {
            public long DefinitionIdentifier;
            public MidnightLightStruct MidnightLightParameters;
            public int SourceFileIdentifier;
            public float IndirectAmplificationFactor;
            public float JitterSphereRadius;
            public float JitterAngle;
            public StructureLightingGenericLightJitterQualityEnum JitterQuality;
            public MidnightBooleanEnum Sun;
            public MidnightBooleanEnum IndirectOnly;
            public StructureLightingGenericLightFlags Flags;
            public MidnightBooleanEnum StaticAnalytic;
            [TagField(Length = 0x3, Flags = TagFieldFlags.Padding)]
            public byte[] Padding;
            
            public enum StructureLightingGenericLightJitterQualityEnum : short
            {
                Low,
                Medium,
                High
            ...
            [Flags]
            public enum StructureLightingGenericLightFlags : uint
            {
                UseNearAttenuation = 1 << 0,
                UseFarAttenuation = 1 << 1,
                InvereSquaredFalloff = 1 << 2,
                LightVersion1 = 1 << 3
            }
        ...
        public class StructureLightingGenericLightInstanceBlock : TagStructure
        {
            public long LightDefinitionId;
            public long LightInstanceId;
            public int LightDefinitionIndex;
            public int MayaSourceHash;
            [TagField(ValidTags = new [] { "ligh" })]
            public CachedTag RuntimeDefinition;
            public StructureLightingLightModeEnum LightMode;
            public RealPoint3d Origin;
            public RealVector3d Forward;
            public RealVector3d Up;
            public float FadeOutDistance;
            public float FadeStartDistance;
            public int ShadowGeometryChecksum;
            [TagField(Length = 0x4, Flags = TagFieldFlags.Padding)]
            public byte[] Padding;
            
            public enum StructureLightingLightModeEnum : int
            {
                Dynamic,
                Static,
                Analytic
        ...
        public class ScreenSpaceLightShaderOverrideBlock : TagStructure
        {
        ...
        public class StructurelightingCinematicLightInstanceBlockStruct : TagStructure
        {
            public long LightInstanceId;
            public int LightDefinitionIndex;
            public int LightInstanceIndex;
            [TagField(Length = 2)]
            public GCinematicshotFlagArray[]  ActiveShots;
            public List<StructurelightingCinematicObjectBlock> LinkedObjects;
            [TagField(Length = 0x4, Flags = TagFieldFlags.Padding)]
            public byte[] Padding;
            ...
            [TagStructure(Size = 0x4)]
            public class StructurelightingCinematicObjectBlock : TagStructure
            {
