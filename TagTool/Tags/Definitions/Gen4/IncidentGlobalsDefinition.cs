...
{
    [TagStructure(Name = "incident_globals_definition", Tag = "ingd", Size = 0xC)]
    public class IncidentGlobalsDefinition : TagStructure
    {
        public List<IncidentDefinitionBlockStruct> Incidents;
