...
{
    [TagStructure(Name = "light_cone", Tag = "licn", Size = 0x58)]
    public class LightCone : TagStructure
    {
        public LightconeFlags Flags;
        [TagField(Length = 0x3, Flags = TagFieldFlags.Padding)]
        public byte[] Padding;
        public MaterialStruct ActualMaterial;
        public float AngleFadeRange; // degrees
        public float AngleFadeCutoff; // degrees
        public float FarFadeRange; // wus
        public float FarFadeCutoff; // wus
        
        [Flags]
        public enum LightconeFlags : byte
        {
            DisabledInSplitScreen = 1 << 0
        }
