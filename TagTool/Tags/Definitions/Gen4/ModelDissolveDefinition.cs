...
{
    [TagStructure(Name = "model_dissolve_definition", Tag = "mdsv", Size = 0xF0)]
    public class ModelDissolveDefinition : TagStructure
    {
        public ModeldissolveFlags Flags;
        public ModeldissolveParticleSpawnPosition ParticleSpawnPosition;
        [TagField(Length = 0x2, Flags = TagFieldFlags.Padding)]
        public byte[] Padding;
        public float ParticleSpawnRandomRadius;
        [TagField(ValidTags = new [] { "cpem" })]
        public CachedTag CheapParticleEmitter;
        public float CheapParticleSpawnDistanceThreshold;
        public float VelocityUp;
        public float VelocityTowardDissolvePoint;
        public float VelocityTowardDissolveSurface;
        public float VelocityAlongDissolveSurface;
        public float VelocityRandom;
        // if non-zero, we normalize the speed to this value
        public float ParticleForcedSpeed;
        public float Duration;
        // particularly for reverse dissolves, to prevent popping
        public float ExtraDuration;
        // particularly for reverse dissolves, to cause particles to arrive at the leading edge
        public float ParticleSpawnTimeOffset;
        public List<ModeldissolvePerRegionTimeOffsetBlock> PerRegionTimeOffset;
        [TagField(ValidTags = new [] { "effe" })]
        public CachedTag DissolvePoint;
        [TagField(ValidTags = new [] { "effe" })]
        public CachedTag OppositeDissolvePoint;
        [TagField(ValidTags = new [] { "effe" })]
        public CachedTag DissolveSurface;
        [TagField(ValidTags = new [] { "effe" })]
        public CachedTag BoundingSphereCenter;
        [TagField(ValidTags = new [] { "effe" })]
        public CachedTag FinishEffect;
        [TagField(ValidTags = new [] { "bloc" })]
        public CachedTag KnightTaintCrate;
        public MaterialStruct ActualMaterial;
        
        [Flags]
        public enum ModeldissolveFlags : byte
        {
            DrawBackfacesOnOverlay = 1 << 0,
            ReverseDissolve = 1 << 1,
            PinToAnimation = 1 << 2,
            TimeParticlesToDieWhenArriving = 1 << 3,
            NeedsTransmissionOverNetwork = 1 << 4,
            CanBeRestarted = 1 << 5,
            BoundingCenterEffectIsTaintSpawn = 1 << 6
        }
        
        public enum ModeldissolveParticleSpawnPosition : sbyte
        {
            DissolveSurface,
            DissolvePoint,
            OppositeFromDissolvePoint
        }
        
        [TagStructure(Size = 0x8)]
        public class ModeldissolvePerRegionTimeOffsetBlock : TagStructure
        {
            public StringId RegionName;
            public float RegionTimeOffset;
        }
