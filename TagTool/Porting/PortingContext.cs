        ...
        public CachedTag PortTag(CachedTag tagToPort, PortingFlags portingFlags = PortingFlags.Default, string[] optMpObjectParams = null)
        {
            ...
            try
            {
                ...
                using (var blamCacheStream = BlamCache.OpenCacheRead())
                {
                    ...
                    var oldFlags = Flags;
                    ConvertTag(cacheStream, blamCacheStream, resourceStreams, tagToPort);
                    Flags = oldFlags;
            ...
            CacheContext.TagCache.TryGetTag($"{tagToPort.Name}.{tagToPort.Group.Tag}", out CachedTag outTag);
